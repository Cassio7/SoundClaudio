...
--Songs SOS
insert into songs(name,id_artist,id_album,durata,mp3) value('SOS',4,4,'','../assets/mp3/Utopia/SOS.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Kill Bill',4,4,'','../assets/mp3/Utopia/Kill.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Seek and Destroy',4,4,'','../assets/mp3/Utopia/Seek.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Low',4,4,'','../assets/mp3/Utopia/Low.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Love Language',4,4,'','../assets/mp3/Utopia/Love.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Blind',4,4,'','../assets/mp3/Utopia/Blind.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Used',4,4,'','../assets/mp3/Utopia/Used.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Snooze',4,4,'','../assets/mp3/Utopia/Snooze.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Notice Me',4,4,'','../assets/mp3/Utopia/Notice.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Gone Girl',4,4,'','../assets/mp3/Utopia/Gone.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Smoking on my Ex Pack',4,4,'','../assets/mp3/Utopia/Smoking.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Ghost in the Machine',4,4,'','../assets/mp3/Utopia/Ghost.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('F2F',4,4,'','../assets/mp3/Utopia/F2F.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Nobody Gets Me',4,4,'','../assets/mp3/Utopia/Nobody.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Conceited',4,4,'','../assets/mp3/Utopia/Conceited.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Special',4,4,'','../assets/mp3/Utopia/Special.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Too Late',4,4,'','../assets/mp3/Utopia/Too.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Far',4,4,'','../assets/mp3/Utopia/Far.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Shirt',4,4,'','../assets/mp3/Utopia/Shirt.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Open Arms',4,4,'','../assets/mp3/Utopia/Open.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('I Hate U',4,4,'','../assets/mp3/Utopia/Hate.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Good Days',4,4,'','../assets/mp3/Utopia/Good.mp3');
insert into songs(name,id_artist,id_album,durata,mp3) value('Forgiveless',4,4,'','../assets/mp3/Utopia/Forgiveless.mp3');
